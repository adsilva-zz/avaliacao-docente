				...
				<center>
					<table>
						<tr>
							<td id="menulinha">
								<ul>
									<li>Bem vindo(a):&emsp;${logado.nome_usuario}
									<li>&emsp;&emsp;&emsp;&emsp;&emsp;
									<a href="./administrador?pagina=curso">Curso</a></li>
									<li>&emsp;&emsp;&emsp;&emsp;&emsp;
									<a href="./administrador?pagina=cadcoordenador">Coordenador</a></li>
									<li>&emsp;&emsp;&emsp;&emsp;&emsp;
									<a href="./administrador?pagina=pergunta">Pergunta</a></li>
									<li>&emsp;&emsp;&emsp;&emsp;&emsp;
									<a href="sair">Sair</a>
								</ul>
							</td>
							...
							<td>
								<%
									...
									if (pagina == null || pagina.isEmpty())
										...
										pagina = "/" + pagina;
								%> <jsp:include page="<%=pagina%>"><jsp:param name="mensagem" value="${param.mensagem }" /></jsp:include>
							</td>
						</tr>
					</table>
				</center>
